  ...
  server: {
    handlers: {
      POST: async ({ request }: { request: Request }) => {
        ...
        const prompt = `You are a golf coach and caddie who specializes in the mental game, trained in the philosophy of Dr. Bob Rotella as described in "Golf is Not a Game of Perfect."
